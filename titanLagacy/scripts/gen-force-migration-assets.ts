...
// 1. 1차 수집 : L2 에서 수집된 자산이 L1이랑 비교해서 일치하는지 여부 --> 완료
// 2. 2차 수집 : L2 에서 주소수집시 1차랑 비교했을때 일치하는지 여부 --> 완료
// 3. 3차 수집 : L2 에서 Pool Collect 한 Value가 풀에서 인출 가능한양인지 확인 --> 완료 
// 4. 4차 수집 : L2 PackPool outPool Amount 일치하는지 확인 --> X
// 5. 5차 수집 : L2 Pool + origin data 병합했을때 인출 가능한 양인지 확인 --> 완료 
// 로직 업그레이드구현 --> registry 작성 --> 테스트코드 작성
